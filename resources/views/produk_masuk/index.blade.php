            ...
            <div class="card">
                <div class="card-header justify-content-between d-flex ">
                    ...
                    <div class="card-header-action ml-auto">
                        <a href="{{ route('produk_masuk.create') }}" class="btn btn-sm btn-primary">+ Tambah</a>
                    </div>
                </div>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a class="btn btn-sm btn-warning mr-2 "
                                                    href="{{ route('produk_masuk.edit', $k->id) }}">Edit</a>


                                                <form action="{{ route('produk_masuk.destroy', $k->id) }}" method="POST"
